      ...
      <div class="card shadow-lg">
        ...
        <div class="card-body pt-sm-3 pt-0">
          ...
          <div class="mt-3">
            ...
            <p class="text-sm">Modiffiez le type de navigation</p>
          </div>
          <div class="d-flex">
          ...
          <p class="text-sm d-xl-none d-block mt-2">You can change the Type de navigation just on desktop view.</p>
          <!-- Bare d'option fixe -->
          <div class="mt-3 d-flex">
            <h6 class="mb-0">Bare d'option fixe</h6>
